...
function ErvinhoLayoutInner({ children }: { children: React.ReactNode }) {
...
export default function ErvinhoLayout({ children }: { children: React.ReactNode }) {
  return (
    <SidebarProvider>
      <NavigationProvider>
        <ErvinhoLayoutInner>{children}</ErvinhoLayoutInner>
      </NavigationProvider>
    </SidebarProvider>
  );
} 